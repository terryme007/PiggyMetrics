 ...
 * 
 */
package com.sunyard.sunfintech.core.lock;
...
public class RedisLock {
	...
	public synchronized boolean lock() throws InterruptedException {
		...
		while (timeout >= 0) {
			...
			this.expireTime = System.currentTimeMillis() + expireMsecs + 1;
			String expiresStr = String.valueOf(this.expireTime); // 锁到期时间
	...
	public synchronized void unlock() {
		...
		String currentValueStr = this.get(lockKey); // redis里的时间
		if (locked && Long.parseLong(currentValueStr) < this.expireTime) {
