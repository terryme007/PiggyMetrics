...
/**
  ...
  38    * your encoded db into a single chunk and then feed them this decoder.
  39    * The simplest way to do that is to read all of the encoded db into a
...
public class BASE64Decoder extends CharacterDecoder {
    ...
    /**
    103        * Decode one BASE64 atom into 1, 2, or 3 bytes of db.
    104        */
