 ...
 * character decoder is an algorithim for transforming 8 bit 39 * binary db
 ...
 * structured 43 * around a central theme that binary db can be encoded into
 * 44 * text that has the form: 45 * 46 *
 * 
 * <pre>
 *    47    *      [Buffer Prefix]
 *    48    *      [Line Prefix][encoded db atoms][Line Suffix]
 *    49    *      [Buffer Suffix]
 *    50    *
 * </pre>
 * 
 ...
 * between the text in an 'atom' and the binary db itself. 55 * 56 * In the
 * CharacterEncoder and CharacterDecoder classes, one complete 57 * chunk of
 * db is referred to as a <i>buffer</i>. Encoded buffers 58 * are all text,
 ...
 * 
 * <pre>
 *    74    *      DecoderClassName: BusinessError message.
 *    75    *
 * </pre>
 * 
...
public abstract class CharacterDecoder {
     ...
     * encoded 183 * buffer and returns a byte array containing the db. 184 * @exception
