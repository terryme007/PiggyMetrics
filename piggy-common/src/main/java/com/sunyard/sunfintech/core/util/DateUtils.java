...
public class DateUtils {
	public final static String DEF_FORMAT = "yyyyMMddHHmmss";
	public final static String DEF_FORMAT_NOTIME = "yyyyMMdd";
	public final static String DEF_FORMAT_NODATE = "HHmmss";
	public final static String DEF_FORMAT_STRING = "yyyyMMddHHmmss";
	public final static String DEF_FORMAT_STRING_DATE = "yyyyMMdd";

	/*
	* 不要直接使用，在并发的时候，会出现异常
	* 参考 SimpleDateFormat 源码解释
	* */
	@Deprecated
	...
	public static final SimpleDateFormat ymd = new SimpleDateFormat(
			"yyyy-MM-dd");
	@Deprecated
	public static final SimpleDateFormat sfm = new SimpleDateFormat(
			"yyyy-MM-dd HH:mm:ss");
	@Deprecated
	...
	public static java.util.Date parseDate(String dateStr) {
		return parseDate(dateStr, DEF_FORMAT);
	}
	...
	public static String todayStr() {
		return formatDateToStr(new Date(), DEF_FORMAT);
	}
	...
	public static Date today() {
		return parseDate(todayStr(), DEF_FORMAT);
	}
	...
	public static String formatDateToStr(Date date) {
		return formatDateToStr(date, DEF_FORMAT);
	}
	 ...
	 * @return
	 */
	public static String formatTime(String time, String fmtSrc, String fmtTag) {
		if (null == fmtSrc)
			return null;
		if (fmtSrc.equals(fmtTag)) {
			return time;
		...
		HH = time.substring(H, H + 2);
		MM = time.substring(M, M + 2);
		SS = time.substring(S, S + 2);
		fmtTag = fmtTag.toUpperCase();
		fmtTag = fmtTag.replaceAll("HH", HH);
		fmtTag = fmtTag.replaceAll("MM", MM);
		fmtTag = fmtTag.replaceAll("SS", SS);
		return fmtTag;
	}
	...
	public static int getTimeSpan(Date startDate,Date endDate) {
	...
	public  static  Date getDateWithoutTime(String expireDateStr) {
		try {
			if (StringUtils.isNotBlank(expireDateStr)) {
				expireDateStr = expireDateStr.replace("-", "");
				expireDateStr = expireDateStr.replace("/", "");
				if (expireDateStr.length() >= 8) {
					expireDateStr = expireDateStr.substring(0, 8);
				}
				return DateUtils.parseDate(expireDateStr, DateUtils.DEF_FORMAT_NOTIME);
			}
		} catch (Exception e) {
			return null;
		}
	...
	public static void main(String[] args) throws ParseException {
		...
		System.out.println(java.sql.Date.valueOf("2015-07-08 15:40:29"));*/
		//System.out.print(DateUtil.curTimeStr());
		//System.out.println(DateUtil.getNow());
	
		
		/*Date nowTime = new Date();
		Date startTime = DateUtils.addOrSubDate(new Date(), Calendar.MINUTE, -20);
		Date endTime = DateUtils.addOrSubDate(new Date(), Calendar.MINUTE, -60);	
		System.out.println(nowTime);
		System.out.println(startTime);
		System.out.println(endTime);*/
		System.out.println(formatTime("121212", "HHmmss", "HH:mm:ss"));
